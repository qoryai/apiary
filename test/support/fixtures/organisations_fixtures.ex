defmodule Apiary.OrganisationsFixtures do
  @moduledoc """
  Test helpers for organisations, hives, memberships and invitations, all
  ...
  @doc """
  Signs a user up, confirms them, and returns the user, organisation, hive,
  ...
  @doc "A pending invitation into the scope's hive, with the URL token the email carried."
  ...
  @doc "A second user who joined the scope's hive through an invitation, at `level`."

// The live end of a timeline (brief-runs rj6). Tells the LiveView whether the reader is
// within 240 px of the end of the page, so that it inserts new items only there and counts
// them elsewhere; and takes the reader to the end when the pill is pressed.
//

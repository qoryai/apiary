// The popover of a connection row's Allow or Deny (brief-policy.md pd8). The server renders
// it while it is open; this hook puts it in the top layer (so the table's scroll container
// cannot clip it), places it under its button, right edges aligned, and gives focus back to
// the button when it goes. Below 768 px the stylesheet makes it a bottom sheet and the
